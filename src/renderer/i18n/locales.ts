...
export const zh = {
  ...
  form: {
    ...
    browseMode: '浏览发现',
    manualMode: '手动输入',
    discoverServers: '发现 SMB 服务器',
    discoveringServers: '正在发现...',
    noServers: '未发现 SMB 服务器',
    selectServer: '选择 SMB 服务器',
    listShares: '列出共享',
    listingShares: '正在列出...',
    showHiddenShares: '显示隐藏共享',
    alreadySaved: '已添加',
    saveAndMount: '保存并挂载',
    saveOnly: '仅保存',
    localMountPoint: '本机挂载点',
    discoveryHint: '发现局域网中的 SMB 服务器，然后选择服务器暴露的共享。',
    credentialsHint: '输入凭据后列出这台 SMB 服务器上的共享。凭据只会在保存时写入配置。',
    chooseMountedShare: '选择已挂载共享',
    chooseMountPath: '选择路径',
    chooseMountedShareHint: '从系统中已挂载的 SMB 共享自动填充服务器、共享名称和路径。',
    chooseMountPathHint: '选择这个共享在本机使用的挂载路径；缺失的目录会自动创建。',
    sharePrefix: '共享',
    localMountPrefix: '本机'
  },
...
export const en = {
  ...
  form: {
    ...
    browseMode: 'Browse',
    manualMode: 'Manual',
    discoverServers: 'Discover SMB Servers',
    discoveringServers: 'Discovering...',
    noServers: 'No SMB servers found',
    selectServer: 'Select SMB Server',
    listShares: 'List Shares',
    listingShares: 'Listing...',
    showHiddenShares: 'Show hidden shares',
    alreadySaved: 'Already added',
    saveAndMount: 'Save and Mount',
    saveOnly: 'Save Only',
    localMountPoint: 'Local Mount Point',
    discoveryHint: 'Find SMB servers on the local network, then select a share exposed by a server.',
    credentialsHint: 'Enter credentials to list shares on this SMB server. Credentials are only stored when you save.',
    ...
    chooseMountPathHint: 'Choose the local path for this share; missing directories are created automatically.',
    sharePrefix: 'Share',
